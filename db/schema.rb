...
ActiveRecord::Schema[8.0].define(version: 2026_02_08_221532) do
  ...
  create_table "default_onboarding_steps", force: :cascade do |t|
    t.integer "account_id", null: false
    t.string "title", null: false
    t.integer "position", default: 0
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_default_onboarding_steps_on_account_id"
  end
  ...
  create_table "onboarding_steps", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["applicant_id"], name: "index_onboarding_steps_on_applicant_id"
  end
  ...
  add_foreign_key "default_onboarding_steps", "accounts"
  add_foreign_key "intakes", "users"
  add_foreign_key "onboarding_steps", "applicants"
